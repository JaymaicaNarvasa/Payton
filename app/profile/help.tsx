...
import { Alert, StatusBar as NativeStatusBar, Platform, SafeAreaView, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  contactBtn: { backgroundColor: '#173D45', height: 50, borderRadius: 14, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 12 },
